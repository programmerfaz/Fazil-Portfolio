    ...
    <a
      ...
      className={
        isLight
          ...
          : `group inline-flex shrink-0 items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-7 py-2.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-white shadow-[0_12px_40px_-16px_rgba(79,70,229,0.45)] backdrop-blur-sm transition-[transform,box-shadow,border-color] duration-200 hover:border-white/18 hover:shadow-[0_16px_48px_-12px_rgba(79,70,229,0.55)] active:scale-[0.98] sm:px-9 sm:py-3 sm:text-xs md:text-sm ${className}`
      }
      style={
        isLight
          ? undefined
          : {
              background: 'linear-gradient(135deg, rgba(67, 56, 202, 0.95) 0%, rgba(99, 102, 241, 0.92) 45%, rgba(30, 27, 75, 0.98) 100%)',
            }
      }
    >
      Contact Me
